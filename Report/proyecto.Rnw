...
\newcommand{\myTitleEng}{Results prediction of real time strategy games' matches}
...
\newcommand{\myKeywords}{Predicción, aprendizaje sobre datos, clasificación, estrategia, planificación}
