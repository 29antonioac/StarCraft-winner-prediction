...
% 2. Puntos suspensivos son puntos. Después va en mayúscula. Y no se
% deben usar en lenguaje formal.
...
Teniendo en mente el crear \emph{bots} para el juego, surge una pregunta.
...
optimización al ahorrar tiempo de juego de partidas. Con una metodología
