...
\newcommand{\myTitleEng}{Results prediction of real time strategy games' matches} % Revisa el inglés!!! - JJ
...
\newcommand{\myKeywords}{Predicción, aprendizaje sobre datos, clasificación, estrategia, planificación} % aprendizaje no se hace siempre sobre datos? - JJ
\newcommand{\myKeywordsEng}{Prediction, learning from data, classification, strategy, planification}
% What? No games? What kind of games? What kind of strategy? No
% optimization? - JJ
