...
\newcommand{\titulo}{Predicción de resultados de partidas en juegos de estrategia en tiempo real}
\newcommand{\tituloEng}{Results prediction of real time strategy games' matches}
